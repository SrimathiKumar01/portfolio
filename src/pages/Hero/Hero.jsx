...
const profile = {
    name: 'Srimathi Kumar',
    title: 'Software Developer | B.Tech IT Student',
    skills: [
        'Java', 'SQL', 'Python',
        'HTML', 'CSS', 'Git',
        'MySQL', 'PostgreSQL', 'OpenCV'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    currentlyLearning: 'Java & SQL',
    hireable: function() {
        return (
            this.hardWorker &&
            this.problemSolver &&
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/SrimathiKumar01"
            ...
            {/* Right column - Enhanced decorative elements instead of code window */}
            <div className="w-full lg:w-1/2 animate__animated animate__fadeInDown animate__delay-0.1s flex items-center justify-center">
